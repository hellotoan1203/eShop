...
namespace eShop.Web
{
    ...
    {
        public static readonly ConcurrentDictionary<string, string> AuthenticationCodes =
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                AppId = Clients.FacebookClient.Id,
                AppSecret = Clients.FacebookClient.Secret,
                AuthorizationEndpoint = "https://www.facebook.com/v3.2/dialog/oauth",
                UserInformationEndpoint = "https://graph.facebook.com/v3.2/me",
                Scope = { "user_location" },
        ...
        {
            if (context.ClientId == Clients.FacebookClient.Id) context.Validated(Clients.FacebookClient.RedirectUrl);
            return Task.FromResult(0);
        }
        ...
        private Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            if (context.TryGetBasicCredentials(out clientId, out clientSecret) ||
                ...
                if (clientId == Clients.FacebookClient.Id && clientSecret == Clients.FacebookClient.Secret)
                    context.Validated();
            return Task.FromResult(0);
        }
        ...
        {
            string value;
            if (AuthenticationCodes.TryRemove(context.Token, out value)) context.DeserializeTicket(value);
        }
